...
int main() {
    ...
    shapes.push_back(Shape(Circle{2}, draw_circle));
    shapes.push_back(Shape(Rect{4, 2}, draw_rect, default_stack_serializtion<Rect>));
    shapes.push_back(Shape(Circle{120}, draw_circle, default_stack_serializtion<Circle>));
