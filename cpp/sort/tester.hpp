 ...
 * This file contains several functions that can be used to measure the total and average execution time of a given function in nanoseconds.
 ...
 *
 * @param f A callable object (e.g. a function, functor, or lambda) to be measured.
...
*/
uint32_t _measure_total_execution_time_nano(std::invocable auto& f, uint32_t num_calls=10000, const std::string& func_name="unnamed") {
...
uint32_t measure_total_execution_time_nano(std::invocable auto& f, uint32_t num_calls=10000) {
    return _measure_total_execution_time_nano(f, num_calls);
}

uint32_t measure_total_execution_time_nano(const std::string& func_name, std::invocable auto& f, uint32_t num_calls=10000) {
    return _measure_total_execution_time_nano(f, num_calls, func_name);
}

uint32_t measure_avg_execution_time_nano(std::invocable auto& f, uint32_t num_calls=10000) {
    return _measure_total_execution_time_nano(f, num_calls) / num_calls;
}

uint32_t measure_avg_execution_time_nano(const std::string& func_name, std::invocable auto& f, uint32_t num_calls=10000) {
    return _measure_total_execution_time_nano(f, num_calls, func_name) / num_calls;
}